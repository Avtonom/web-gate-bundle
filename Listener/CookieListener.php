...
namespace Avtonom\WebGateBundle\Listener;
...
class CookieListener extends \Buzz\Listener\CookieListener
{
    protected $cookieJar;

    public function __construct()
    {
        $this->cookieJar = new \Avtonom\WebGateBundle\Util\CookieJar();
    }
